...
Kurmak için [NuGet (https://www.nuget.org/packages/TS.Pusula)](https://www.nuget.org/packages/TS.Pusula/) burayı ziyaret edebilirsiniz

Ya da aşağıdaki kod bloğunu çalıştırarak kurabilirsiniz

```powershell
dotnet new install TS.Pusula
```

kurulum bittikten sonra `dotnet new list` ile VS2022 proje listesini görüntüleyip "ASP.NET Clean Architecture Solution" kısa adı "ts.pusula" proje template'ini arayabilirsiniz. Eğer listede bulduysanız artık VS2022 üzerinden yeni proje oluştur deyip proje arama çubuğunda "Clean Architecture" diye arayarak bulabilirsiniz.

![Proje Template](https://github.com/TanerSaydam/Pusula.Template/blob/main/images/projeyibulma.png)

Projeyi seçtikten sonra istediğiniz ismi verin örneğin `eCommerce`

![Proje Structure](https://github.com/TanerSaydam/Pusula.Template/blob/main/images/projestructure.png)
...
![Connection String](https://github.com/TanerSaydam/Pusula.Template/blob/main/images/connectionstring.png)
...
![Create First User](https://github.com/TanerSaydam/Pusula.Template/blob/main/images/createfirstuser.png)
